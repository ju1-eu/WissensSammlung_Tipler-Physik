...
class KraftstoffRechner:
    ...
    def berechne_kraftstoffverbrauch(self, params: VerbrauchsParameter) -> Dict[str, float]:
        """
    ...
    def sensitivitaetsanalyse(self, params: VerbrauchsParameter,
                           eta_bereich: Optional[list] = None) -> Dict[float, float]:
        """
        ...
        for eta in eta_bereich:
            ...
            verbrauch = self.berechne_kraftstoffverbrauch(test_params)["Verbrauch [l/100km]"]
    ...
    def erstelle_plot(self, params: VerbrauchsParameter) -> plt.Figure:
        ...
        eta_range = np.linspace(
            self.konstanten.MIN_WIRKUNGSGRAD,
            self.konstanten.MAX_WIRKUNGSGRAD,
            100
        )
        ...
        ax.set_title('Kraftstoffverbrauch bei 180 km/h\nAbhängigkeit vom Motorwirkungsgrad')
        ax.grid(True)
        ax.legend()
