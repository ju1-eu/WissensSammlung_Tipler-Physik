...
class VektorBerechnung:
    ...
    def berechne_baer_verschiebung(
        self, r1_betrag: float, r1_winkel: float, r2_betrag: float, r2_winkel: float
    ) -> Dict[str, float]:
        """
    ...
    def berechne_schiffsposition(
        self, abstand_sender: float, winkel_a: float
    ) -> Dict[str, float]:
        """
    ...
    def formatiere_ergebnis(
        self, wert: float, einheit: str, nachkommastellen: int = 2
    ) -> str:
        """
...
def main():
    ...
    try:
        ...
        if wahl == "1":
            ...
            ergebnis = rechner.berechne_baer_verschiebung(
                r1_betrag, r1_winkel, r2_betrag, r2_winkel
            )
            print("\nErgebnis:")
