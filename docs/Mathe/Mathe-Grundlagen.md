...
- **Beispiel**: 
  $\sqrt[3]{8} = 2$
  (Aussprache: „Dritte Wurzel aus 8“)
...
- **Nach oben unbeschränkt**: 
  $[a, \infty)$ oder $(a, \infty)$

- **Nach unten unbeschränkt**: 
  $(-\infty, b]$ oder $(-\infty, b)$
...
2. **Mengennotation**:
   - $A = \{x \mid x \text{ ist ein Viereck}\}$
   - $B = \{1, 2, 3\}$
   - $C = \{1, 2, 3, \dots\}$ (eine unendliche Menge)

3. **Teilmengen**:
   - $A \subseteq B$: $A$ ist eine Teilmenge von $B$ (alle Elemente von $A$ sind auch in $B$ enthalten)
   - $A \subset B$: $A$ ist eine echte Teilmenge von $B$ (alle Elemente von $A$ sind in $B$, aber $B$ enthält mindestens ein Element, das nicht in $A$ ist)
   - Die Teilmenge von $A$ und $B$ ist die Menge aller gemeinsamen Elemente.
...
5. **Kardinalität $|A|$**:
   - $|A| = n$: Anzahl der Elemente in $A$.
   - $|A| = \infty$: Eine unendliche Menge.
   - $|P(A)| = 2^n$: Anzahl der Elemente in der Potenzmenge von $A$.
...
### 1. Erste binomische Formel (Quadrat einer Summe)
...
Umgeformt zur Berechnung der Zinsen:
...
1. **10% von 150 EUR**
   ...
   **Ergebnis:** $10\%$ von $150~\text{EUR} = 15~\text{EUR}$
...
2. **15% von 240 EUR**
   ...
   **Ergebnis:** $15\%$ von $240~\text{EUR} = 24~\text{EUR} + 12~\text{EUR} = 36~\text{EUR}$
...
3. **60% von 500 EUR**
   ...
   **Ergebnis:** $60\%$ von $500~\text{EUR} = 250~\text{EUR} + 50~\text{EUR} = 300~\text{EUR}$
...
4. **85% von 600 EUR**
   ...
   **Ergebnis:** $85\%$ von $600~\text{EUR} = 600~\text{EUR} - 90~\text{EUR} = 510~\text{EUR}$
...
5. **15% von 141 EUR**
   ...
   **Ergebnis:** $15\%$ von $141~\text{EUR} = 14,1~\text{EUR} + 7,05~\text{EUR} = 21,15~\text{EUR}$
...
6. **25% von 222 EUR**
   ...
   **Ergebnis:** $25\%$ von $222~\text{EUR} = 44,4~\text{EUR} + 11,1~\text{EUR} = 55,5~\text{EUR}$
...
1. **54% von 440 EUR**
   ...
   **Ergebnis:** $54\%$ von $440~\text{EUR} = 220~\text{EUR} + 17,6~\text{EUR} = 237,6~\text{EUR}$
...
2. **63% von 420 EUR**
   ...
   **Ergebnis:** $63\%$ von $420~\text{EUR} = 210~\text{EUR} + 42~\text{EUR} + 12,6~\text{EUR} = 264,6~\text{EUR}$
...
3. **98% von 250 EUR**
   ...
   **Ergebnis:** $98\%$ von $250~\text{EUR} = 250~\text{EUR} - 5~\text{EUR} = 245~\text{EUR}$
